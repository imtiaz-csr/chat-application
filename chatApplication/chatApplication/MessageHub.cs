...
namespace chatApplication
{
    public class MessageHub : Hub
    {
        ...
        public async Task Upload(string user, ImageData data)
        {
            ...
            else await Clients.All.SendAsync("Message", user, $"<a target='_blank' href='/Images/{data.Filename}'><img src='/Images/docs.png' width='40px'  class='img-thumbnail circle'/> </a>");
        }
    }
}
